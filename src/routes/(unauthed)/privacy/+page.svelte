<h1 class="text-3xl font-bold">Privacy Policy for Forebalance</h1>
<br />

At Forebalance, accessible from www.forebalance.app, one of our main priorities is the privacy of
our visitors. This Privacy Policy document contains types of information that is collected and
recorded by Forebalance and how we use it.
<br /><br />
...
with regards to the information that they shared and/or collect in Forebalance. This policy is not
...
Forebalance follows a standard procedure of using log files. These files log visitors when they
...
that are used in their respective advertisements and links that appear on Forebalance, which are
...
Note that Forebalance has no access to or control over these cookies that are used by third-party
advertisers.
<br /><br />

<h2 class="text-2xl font-bold">Third Party Privacy Policies</h2>

Forebalance's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
...
is inaccurate. You also have the right to request that we complete the information you believe is incomplete.
<br /><br />
...
Forebalance does not knowingly collect any Personal Identifiable Information from children under the
